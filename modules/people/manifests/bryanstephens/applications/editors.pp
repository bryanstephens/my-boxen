class people::bryanstephens::applications::editors {
  ...
  file { "${sublime_text::config::packagedir}/User":
    ...
    target => "${people::bryanstephens::config::dotfiles_dir}/sublime3/User",
    require => [
  ...
  file { "${sublime_text::v2::config::packagedir}/User":
    ...
    target => "${people::bryanstephens::config::dotfiles_dir}/sublime2/User",
    require => [
      Repository[$people::bryanstephens::config::dotfiles_dir],
